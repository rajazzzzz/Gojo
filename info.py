...
BOT_TOKEN = environ.get('BOT_TOKEN', "6524962251:AAGzGQd7X4U5WNlbsT8S-gfatXhWo1_jq38")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mavi:mavi@cluster0.g5gbgkz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "MaviV3")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'v3coll')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://mavimoviev3.onrender.com/")
